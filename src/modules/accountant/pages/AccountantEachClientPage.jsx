                  ...
                  <div className="document-item" style={{ cursor: "default" }}>
                    <div className="document-info">
                      ...
                      <div className="document-details">
                        ...
                        <p>Zoho has not returned any uploaded client files for this record yet.</p>
                      </div>
                    </div>
                  </div>
                ) : (
                ...
                {clientData.payments.length === 0 ? (
                  <tr>
                    <td colSpan="4" style={{ textAlign: "center", padding: "32px", color: "var(--text-light)" }}>
                      No payment records were returned from Zoho for this client.
                    </td>
                  </tr>
                ) : (
                ...
                <div className="document-item" style={{ cursor: "default" }}>
                  <div className="document-info">
                    ...
                    <div className="document-details">
                      ...
                      <p>Zoho has not returned accountant-side report attachments for this client yet.</p>
                    </div>
                  </div>
                </div>
              ) : (
