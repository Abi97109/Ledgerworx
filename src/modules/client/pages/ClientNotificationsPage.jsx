...
export default function ClientNotificationsPage() {
    ...
    const [notificationItems, setNotificationItems] = useState(() => getClientNotificationItems());
    ...
    useEffect(() => {
        function syncNotificationItems() {
            setNotificationItems(getClientNotificationItems());
        }

        window.addEventListener('storage', syncNotificationItems);
        window.addEventListener('client-notifications-updated', syncNotificationItems);

        return function cleanup() {
            window.removeEventListener('storage', syncNotificationItems);
            window.removeEventListener('client-notifications-updated', syncNotificationItems);
        };
    }, []);
