...
import { createClientServiceRequestNotification } from '../data/notificationsData';
...
import { addClientNotification } from '../utils/notificationStorage';
...
export default function ClientSubServicesPage() {
    ...
    async function handleRequestSubmit(event) {
        ...
        try {
            const createdRequest = await createRequestMutation.mutateAsync(newRequest);
            const requestId =
                (createdRequest && (createdRequest.requestId || createdRequest.id))
                || newRequest.requestId;

            addClientNotification(
                createClientServiceRequestNotification({
                    requestId,
                    serviceName: selectedService.name,
                    category: selectedCategory.title,
                    submittedAt: createdRequest && createdRequest.createdAt ? createdRequest.createdAt : newRequest.createdAt
                })
            );
