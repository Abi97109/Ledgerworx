      ...
      <div className="container">
        ...
        <div className="filters-section">
          <div className="filter-tabs">
            ...
            <span className={filter === "overdue" ? "active" : ""} onClick={() => setFilter("overdue")}>
              <i className="fas fa-exclamation-circle"></i> Overdue
            </span>
            <span className={filter === "today" ? "active" : ""} onClick={() => setFilter("today")}>
              <i className="fas fa-calendar-day"></i> Today
            </span>
            <span className={filter === "upcoming" ? "active" : ""} onClick={() => setFilter("upcoming")}>
