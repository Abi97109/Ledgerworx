...
import clientPaymentsCssUrl from "../styles/client-payments.css?url";
...
function ClientPaymentsPage() {
  usePageStyles([clientPaymentsCssUrl, clientBreadcrumbCssUrl, darkModeCssUrl]);
  ...
  const submitToPaymentGateway = useCallback(
    (payload) => {
      const query = new URLSearchParams(payload);
      navigate(`${CLIENT_ROUTE_PATHS.paymentGateway}?${query.toString()}`);
    },
    [navigate],
  );
