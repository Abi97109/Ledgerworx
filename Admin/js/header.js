    ...
    s.appendChild(
      document.createTextNode(
        [
          ...
          'body.dark .topbar, body.dark .navbar{background:linear-gradient(135deg,#1b6f6b,#27978f) !important;}',
          ...
          'body.dark .muted, body.dark .subtitle, body.dark .small, body.dark .helper, body.dark .meta{color:#aab8c5 !important;}',
          'body.dark .card h1, body.dark .card h2, body.dark .card h3, body.dark .card h4, body.dark .tile h1, body.dark .tile h2, body.dark .tile h3, body.dark .tile h4{color:#e6eef6 !important;}',
          'body.dark .card p, body.dark .tile p, body.dark .kpi p, body.dark td, body.dark th{color:#d7e4ef !important;}',
        ].join('')
      )
    );
