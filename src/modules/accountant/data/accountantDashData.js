...
export const ACCOUNTANT_LEGACY_PATHS = {
  logo: "accountant-n/assets/logowhite.png",
  dashboard: "accountant-n/php/accountant-dash.php",
  clients: "accountant-n/php/accountant-client.php",
  tasks: "accountant-n/php/accountant-tasks.php",
  payments: "accountant-n/php/accountant-payment.php",
  invoices: "accountant-n/php/accountant-invoices.php",
  profile: "accountant-n/php/accountant-profile.php",
  settings: "accountant-n/php/accountant-settings.php",
  help: "accountant-n/php/accountant-help.php",
  logout: "accountant-n/php/logout.php",
  taskView: "accountant-n/php/accountant-task-view.php",
  taskCompletePortal: "accountant-n/php/accountant-complete-portal.php",
  eachClient: "accountant-n/php/accountant-each-client.php",
  zohoApi: "accountant-n/php/accountant-zoho-api.php",
};
