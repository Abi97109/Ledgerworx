  ...
  <div class="lead-header">
    ...
    <div class="lead-header-content">
      ...
      <div class="header-buttons">
        <button class="lw-btn btn-primary" data-action="open-note-modal">📝 Add Note / Follow-Up</button>
        <button class="lw-btn btn-primary" data-action="assign-service">🔄 Assign Service</button>
        <button class="lw-btn btn-primary" data-action="open-transfer-modal"><i class="fas fa-exchange-alt"></i> Transfer Lead</button>
        <button class="lw-btn btn-secondary" data-action="convert-to-client">✓ Convert to Client</button>
      </div>
    </div>
  </div>
