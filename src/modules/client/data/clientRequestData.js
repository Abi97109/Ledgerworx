export const CLIENT_REQUEST_STORAGE_KEY = "ledgerworxClientServiceRequests";
export const CLIENT_REQUEST_ICON_TONE_CLASSES = ["orange", "green", "purple", "blue", "teal"];

export const CLIENT_DEFAULT_REQUESTS = [
  {
    ...
    overview:
      "Prepare and submit quarterly business setup documentation and authority-facing records for review.",
    instructions: [
  ...
  },
  {
    ...
    category: "Accounting",
    overview:
      "Complete monthly bookkeeping and reconciliation of all accounts with accurate financial record-keeping.",
    instructions: [
  ...
  },
  {
    ...
    category: "Taxation",
    overview:
      "VAT return filed with all required tax compliance checks and submission confirmation.",
    instructions: [
