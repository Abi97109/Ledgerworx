...
$companyOptions = array_values(array_unique(array_map(function($row) {
  return $row['company'];
}, $invoices)));
sort($companyOptions);
...
<link rel="stylesheet" href="../css/header.css">
  <link rel="stylesheet" href="../css/admin_accounts.css?v=<?php echo filemtime(__DIR__ . '/../css/admin_accounts.css'); ?>">
