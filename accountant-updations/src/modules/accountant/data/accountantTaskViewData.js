...
export const ACCOUNTANT_TASK_VIEW_LOADING_TEXT = "Preparing task details...";

export const ACCOUNTANT_TASK_VIEW_SOURCE_TEXT = {
  noTaskId: "No task ID was provided. Showing preview details.",
  preview: "Preview task data loaded from the accountant React app.",
  fallback: "Preview task data loaded from the accountant React app.",
  loadFailed: "Preview task data loaded from the accountant React app.",
  connectionFailed: "Preview task data loaded from the accountant React app.",
};
