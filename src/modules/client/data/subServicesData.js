export const clientSubServicesPageMeta = {
    pageTitle: 'LedgerWorx - Sub Services',
    profileName: 'John Doe',
    profileImage: 'https://i.pravatar.cc/40',
    subtitle: 'Sub services available in this category'
};

export const clientSubServiceCategories = {
    'business-setup': {
        key: 'business-setup',
...
export function getClientSubServiceCategory(categoryKey) {
    const normalizedKey = String(categoryKey || '').trim();
    if (clientSubServiceCategories[normalizedKey]) {
        return clientSubServiceCategories[normalizedKey];
    }
