...
import { clientMoreServicesPageData } from '../data/moreServicesData';
import { usePageStyles } from '../hooks/usePageStyles';
import { buildClientAvatar } from '../utils/dashboardUtils';
import { buildLegacyUrl } from '../../../utils/legacyLinks';
import clientMoreServicesCssUrl from '../styles/clientMoreServices.css?url';
...
function ClientMoreServicesPage() {
    usePageStyles([clientMoreServicesCssUrl, clientBreadcrumbCssUrl, clientDashboardDarkModeCssUrl]);

    const { profileName, profileImage, navLinks, services } = clientMoreServicesPageData;
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <h1 className="page-title">More Services</h1>
                <p className="page-subtitle">Explore additional service offerings</p>

                <div className="services-grid">
                    {services.map((service) => (
                        <a key={service.id} href={buildLegacyUrl(service.href)} className="service-link">
...
export default ClientMoreServicesPage;
