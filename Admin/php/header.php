...
<header class="topbar">
  <div style="display:flex; align-items:center; gap:12px;">
    ...
    <nav class="nav-items">
      <div class="nav-items-inner">
        ...
        <a href="admin_zoho.php" class="<?php echo $currentPage==='admin_zoho.php' ? 'active':''; ?>"><i class="fa-solid fa-link ico"></i> Zoho</a>
  ...
  <div style="display:flex; align-items:center; gap:18px;">
    <div class="search" style="margin-right:12px;"><i class="fa-solid fa-magnifying-glass" style="margin-right:8px;color:#fff"></i><input placeholder="Search"></div>
