...
import { fetchPortalCatalog, fetchPortalDashboard, fetchPortalInvoices, fetchPortalNotifications } from '../api/portalApi';
...
export function usePortalNotificationsQuery(options = {}) {
    return useQuery({
