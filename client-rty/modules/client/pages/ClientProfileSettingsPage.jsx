...
import clientProfileSettingsCssUrl from "../styles/client-profile-settings.css?url";
...
function ClientProfileSettingsPage() {
  usePageStyles([clientProfileSettingsCssUrl, clientBreadcrumbCssUrl, darkModeCssUrl]);
